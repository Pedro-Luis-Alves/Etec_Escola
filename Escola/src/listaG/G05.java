...
/* Desenvolva  um  programa  para  auxiliar  uma  
		 * escolinha  de  futebol  na  classificação  
		 * das categorias das equipes de futebol. 
		 * O programa deverá ler a idade da criança e 
		 * apresentar o nome da categoria em a criança 
		 * deve jogar, através da tabela abaixo:
		 * 
		 * Idade			Categoria
		 * 
